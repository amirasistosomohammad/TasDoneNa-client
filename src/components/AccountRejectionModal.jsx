...
import { FaTimesCircle, FaUserShield, FaExclamationTriangle } from "react-icons/fa";

/**
 * Professional Account Rejection Modal
 * Displays detailed rejection information with administrator remarks
 * Corporate/government style with responsive design
 */
export const showAccountRejectionModal = (reason = "", onClose = null) => {
  const hasRemarks = reason && reason.trim().length > 0;
  ...
  return Swal.fire({
    ...
    html: `
      <div class="account-rejection-modal">
        ...
        <h2 class="account-rejection-title">Account Rejected</h2>
        
        <div class="account-rejection-content">
          <p class="account-rejection-intro">
            Your account registration has been reviewed and rejected by an administrator.
          </p>
          ...
          ${hasRemarks ? `
            <div class="account-rejection-remarks-section">
              <div class="account-rejection-remarks-header">
                ...
                <span class="account-rejection-remarks-label">Administrator Remarks</span>
              </div>
          ...
          ` : `
            <div class="account-rejection-no-remarks">
              ...
              <p class="account-rejection-no-remarks-text">No specific remarks provided.</p>
            </div>
          `}
